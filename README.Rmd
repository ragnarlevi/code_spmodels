...
The experiments in the paper were run by running `poisson_test.R`, `zip_test.R`,  `hurdle_test.R`, `speed_test.R` and `test_direct_vs_em.R`, but they do take quite some time to run.
